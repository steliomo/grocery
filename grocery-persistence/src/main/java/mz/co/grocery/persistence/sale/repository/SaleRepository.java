...
public interface SaleRepository extends GenericDAO<SaleEntity, Long> {
	...
	class QUERY {
		...
		public static final String findPendingOrImpletePaymentSaleStatusByCustomer = "SELECT s FROM SaleEntity s WHERE s.customer.uuid = :customerUuid AND s.saleStatus IN ('PENDING', 'INCOMPLETE') AND s.entityStatus = :entityStatus";
		...
		public static final String fetchByUuid = "SELECT s FROM SaleEntity s LEFT JOIN FETCH s.items i WHERE s.uuid = :uuid AND s.entityStatus = :entityStatus AND i.entityStatus = :entityStatus";
	...
	class QUERY_NAME {
		...
		public static final String findPendingOrImpletePaymentSaleStatusByCustomer = "SaleEntity.findPendingOrImpletePaymentSaleStatusByCustomer";
