...
@NamedQueries({
	...
	@NamedQuery(name = SaleItemRepository.QUERY_NAME.findSaleItemsByUnitAndPeriodAndSaleStatus, query = SaleItemRepository.QUERY.findSaleItemsByUnitAndPeriodAndSaleStatus)
})
@Entity
